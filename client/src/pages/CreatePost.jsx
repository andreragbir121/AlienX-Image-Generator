  ...
  return (
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <h1 className="font-extrabold text-[#222328] text-[32px]"> Create
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w [500px]'>create imaginative and visually stunning images, through DALL-E AI and share them with a community of users</p>
        </div>

        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}> 

          <div className="flex felx-col gap gap-5"> 
          <FormField
          labelName = "prompt"
          type = "text"
          name="prompt"
